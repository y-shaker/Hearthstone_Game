...
public class CastConfirm extends JWindow{
	...
	public CastConfirm(){
		...
		msg=new JTextField("Cast this spell ?");
		...
		confirm = new JButton(new ImageIcon("images/CastButton.png"));
